...
{
    /// <summary>
    /// This class contains extensions methods for the MessageReceiver class
    /// </summary>
    public static class MessageReceiverClientExtensions
    {
            ...
            int messageCount)
        {
            ...
            var peekedMessages = messageReceiver.PeekBatch(fromSequenceNumber, messageCount);
            ...
            {
                peekedMessages = messageReceiver.PeekBatch(messageCount - peekedMessageCount);
